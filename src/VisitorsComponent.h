...
struct VisitorsComponent : public juce::Component
{
    ...
    void resized() override
    {
        ...
        for (int i = 0; i < 12; ++i)
        {
            ...
            if (i < 7)
            {
                commas[i]->setBounds(5 * (1 + i) + diameter * i, diameter * 4 + 10, diameter, diameter);
            }
        }
    }
    ...
    void paint(juce::Graphics &g) override
    {
        ...
        for (int i = 0; i < 12; ++i)
        {
            ...
            if (i < 7)
            {
                ...
                g.setColour(juce::Colours::black);
                g.fillEllipse(left2, diameter * 4 + 10, diameter, diameter);
                ...
                {
                    g.setColour(juce::Colours::white);
                    g.drawEllipse(left2, diameter * 4 + 10, diameter, diameter, 3.f);
                }
            }
        }
    }
