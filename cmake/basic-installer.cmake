...
if (WIN32)
    set(JI_LATTICE_ZIP BStep-${JI_LATTICE_DATE}-${VERSION_CHUNK}-${CMAKE_SYSTEM_NAME}-${BITS}bit.zip)
else ()
    set(JI_LATTICE_ZIP BStep-${JI_LATTICE_DATE}-${VERSION_CHUNK}-${CMAKE_SYSTEM_NAME}.zip)
endif ()
